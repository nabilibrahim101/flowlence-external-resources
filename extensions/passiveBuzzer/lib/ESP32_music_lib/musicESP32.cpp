...
/////////////////////////////////////////////
/////////////////////////////////////////////
void music::buzz(uint8_t targetPin, long frequency, long length)
{
  // Handle REST notes (frequency = 0) to avoid division by zero
  if (frequency == 0) {
    delay(length);
    return;
  }
...
void music::christmas(void)
{
  ...
  {
    tone(buzzer_pin, tune_christmas[x],500*durt_christmas[x]);
